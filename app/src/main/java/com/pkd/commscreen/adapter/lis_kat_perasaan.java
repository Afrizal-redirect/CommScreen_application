...
public class lis_kat_perasaan extends RecyclerView.Adapter<lis_kat_perasaan.ViewHolder> {
    ...
    public lis_kat_perasaan(ArrayList listKata, Activity mActivity) {
        this.listkata = listKata;
        this.mActivity = mActivity;
        ref = FirebaseDatabase.getInstance ().getReference ().child ("Kategori Perasaan");
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View V = LayoutInflater.from (parent.getContext ()).inflate (R.layout.perasaan_layout, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        getImage ("Gambar/" + nama + ".png", holder.gambar_perasaan);
        ...
        holder.gambar_perasaan.setOnClickListener (new View.OnClickListener () {
            @Override
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            gambar_perasaan = itemView.findViewById (R.id.gambar_perasaan);
