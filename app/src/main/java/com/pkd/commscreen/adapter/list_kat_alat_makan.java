...
public class list_kat_alat_makan extends RecyclerView.Adapter<list_kat_alat_makan.ViewHolder> {
    //musik variabel
    ...
    @NonNull
    @Override
    public list_kat_alat_makan.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View V = LayoutInflater.from (parent.getContext ()).inflate (R.layout.alat_makan_lay, parent, false);
        return new ViewHolder (V);
    }

    @Override
    public void onBindViewHolder(@NonNull list_kat_alat_makan.ViewHolder holder, int position) {
    ...
    public list_kat_alat_makan(ArrayList listKata, Activity mActivity) {
        this.listkata = listKata;
        this.mActivity = mActivity;

        ref = FirebaseDatabase.getInstance ().getReference ().child ("Kategori Alat Makan");
        reference = FirebaseStorage.getInstance ().getReference ();

    }

    public void getImage(String data, final ImageView gambar_alat_makan) {
        ...
        reference.child (data).getDownloadUrl ().addOnSuccessListener (new OnSuccessListener<Uri> () {
            ...
            public void onSuccess(Uri uri) {
                ...
                Glide.with (mActivity).load (uri).into (gambar_alat_makan);
            }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            gambar_verba = itemView.findViewById (R.id.gambar_alat_makan);
        }
    }
}
