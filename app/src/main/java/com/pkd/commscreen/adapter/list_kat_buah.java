...
public class list_kat_buah extends RecyclerView.Adapter<list_kat_buah.ViewHolder> {
    ...
    @NonNull
    @Override
    public list_kat_buah.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View V = LayoutInflater.from (parent.getContext ()).inflate (R.layout.buah_lay, parent, false);
        return new ViewHolder (V);
    }

    @Override
    public void onBindViewHolder(@NonNull list_kat_buah.ViewHolder holder, int position) {
        ...
        getImage ("Gambar/" + nama + ".png", holder.gambar_buah);
        ...
        holder.gambar_buah.setOnClickListener (new View.OnClickListener () {
            @Override
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            gambar_buah = itemView.findViewById (R.id.gambar_buah);
        }
    }

    public void getImage(String data, final ImageView gambar_buah) {
        ...
        reference.child (data).getDownloadUrl ().addOnSuccessListener (new OnSuccessListener<Uri> () {
            ...
            public void onSuccess(Uri uri) {
                ...
                Glide.with (mActivity).load (uri).into (gambar_buah);
            }
    ...
    public list_kat_buah(ArrayList listKata, Activity mActivity) {
        this.listkata = listKata;
        this.mActivity = mActivity;

        ref = FirebaseDatabase.getInstance ().getReference ().child ("Kategori Buah");
