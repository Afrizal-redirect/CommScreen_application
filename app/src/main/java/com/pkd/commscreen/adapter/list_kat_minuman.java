...
public class list_kat_minuman  extends RecyclerView.Adapter<list_kat_minuman.ViewHolder> {
    ...
    @NonNull
    @Override
    public list_kat_minuman.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View V = LayoutInflater.from (parent.getContext ()).inflate (R.layout.minuman_lay, parent, false);
        return new ViewHolder (V);
    }

    @Override
    public void onBindViewHolder(@NonNull list_kat_minuman.ViewHolder holder, int position) {
    ...
    public void getImage(String data, final ImageView gambar_minuman) {
        ...
        reference.child (data).getDownloadUrl ().addOnSuccessListener (new OnSuccessListener<Uri> () {
            ...
            public void onSuccess(Uri uri) {
                ...
                Glide.with (mActivity).load (uri).into (gambar_minuman);
            }
    ...
    public list_kat_minuman(ArrayList listKata, Activity mActivity) {
        this.listkata = listKata;
        this.mActivity = mActivity;

        ref = FirebaseDatabase.getInstance ().getReference ().child ("Kategori Minuman");
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            gambar_verba = itemView.findViewById (R.id.gambar_minuman);
