...
public class list_kat_sajak extends RecyclerView.Adapter<list_kat_sajak.ViewHolder> {
    //musik variabel
    ...
    @NonNull
    @Override
    public list_kat_sajak.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View V = LayoutInflater.from (parent.getContext ()).inflate (R.layout.sajak_lay, parent, false);
        return new ViewHolder (V);
    }

    @Override
    public void onBindViewHolder(@NonNull list_kat_sajak.ViewHolder holder, int position) {
    ...
    public void getImage(String data, final ImageView gambar_sajak) {
        ...
        reference.child (data).getDownloadUrl ().addOnSuccessListener (new OnSuccessListener<Uri> () {
            ...
            public void onSuccess(Uri uri) {
                ...
                Glide.with (mActivity).load (uri).into (gambar_sajak);
            }
    ...
    public list_kat_sajak(ArrayList listKata, Activity mActivity) {
        this.listkata = listKata;
        this.mActivity = mActivity;

        ref = FirebaseDatabase.getInstance ().getReference ().child ("Kategori Sajak");
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            gambar_verba = itemView.findViewById (R.id.gambar_sajak);
        }
    }
