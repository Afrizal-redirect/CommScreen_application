...
public class list_kat_trans extends RecyclerView.Adapter<list_kat_trans.ViewHolder> {
    //musik variabel
    ...
    @NonNull
    @Override
    public list_kat_trans.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View V = LayoutInflater.from (parent.getContext ()).inflate (R.layout.trans_lay, parent, false);
        return new ViewHolder (V);
    }

    @Override
    public void onBindViewHolder(@NonNull list_kat_trans.ViewHolder holder, int position) {
    ...
    public void getImage(String data, final ImageView gambar_trans) {
        ...
        reference.child (data).getDownloadUrl ().addOnSuccessListener (new OnSuccessListener<Uri> () {
            ...
            public void onSuccess(Uri uri) {
                ...
                Glide.with (mActivity).load (uri).into (gambar_trans);
            }
    ...
    public list_kat_trans(ArrayList listKata, Activity mActivity) {
        this.listkata = listKata;
        this.mActivity = mActivity;

        ref = FirebaseDatabase.getInstance ().getReference ().child ("Kategori Transpostasi");
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            gambar_verba = itemView.findViewById (R.id.gambar_trans);
        }
    }
}
