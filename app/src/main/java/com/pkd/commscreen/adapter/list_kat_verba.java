...
public class list_kat_verba extends RecyclerView.Adapter<list_kat_verba.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            gambar_verba = itemView.findViewById (R.id.gambar_verba);
    ...
    public list_kat_verba(ArrayList listKata, Activity mActivity) {
        this.listkata = listKata;

        this.mActivity = mActivity;

        ref = FirebaseDatabase.getInstance ().getReference ().child ("Kategori Verba");
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View V = LayoutInflater.from (parent.getContext ()).inflate (R.layout.activity_kat_verba, parent, false);
