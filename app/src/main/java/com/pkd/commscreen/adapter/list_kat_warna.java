...
public class list_kat_warna extends RecyclerView.Adapter<list_kat_warna.ViewHolder> {
    //musik variabel
    ...
    @NonNull
    @Override
    public list_kat_warna.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View V = LayoutInflater.from (parent.getContext ()).inflate (R.layout.warna_lay, parent, false);
        return new ViewHolder (V);
    }

    @Override
    public void onBindViewHolder(@NonNull list_kat_warna.ViewHolder holder, int position) {
//Mengambil Nilai/Value yenag terdapat pada RecyclerView berdasarkan Posisi Tertentu
    ...
    public list_kat_warna(ArrayList listKata, Activity mActivity) {
        this.listkata = listKata;
        this.mActivity = mActivity;

        ref = FirebaseDatabase.getInstance ().getReference ().child ("Kategori Warna");
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            gambar_verba = itemView.findViewById (R.id.gambar_warna);
        }
    }
}
