...
public class list_menu_utama extends RecyclerView.Adapter<list_menu_utama.ViewHolder> {
    ...
    @NonNull
    @Override
    public list_menu_utama.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        //Membuat View untuk Menyiapkan dan Memasang Layout yang Akan digunakan pada RecyclerView
        View V = LayoutInflater.from (parent.getContext ()).inflate (R.layout.menu_lay, parent, false);
        return new ViewHolder (V);
    }

    //Membuat Konstruktor, untuk menerima input dari Database
    public list_menu_utama(ArrayList listKata, Activity mActivity) {
        this.listkata = listKata;
        this.mActivity = mActivity;
        ref = FirebaseDatabase.getInstance ().getReference ().child ("Kategori Menu");
        reference = FirebaseStorage.getInstance ().getReference ();

    }

    public void getImage(String data, final ImageView gambar_menu) {
        ...
        reference.child (data).getDownloadUrl ().addOnSuccessListener (new OnSuccessListener<Uri> () {
            ...
            public void onSuccess(Uri uri) {
                ...
                Glide.with (mActivity).load (uri).into (gambar_menu);
            }
    ...
    @Override
    public void onBindViewHolder(@NonNull list_menu_utama.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            gambar_keluarga = itemView.findViewById (R.id.gambar_menu);
